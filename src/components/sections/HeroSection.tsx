...
export const HeroSection = ({ content, themeColor }: { content: Section["content"]; themeColor: string }) => (
  ...
  <div className={`text-center h-[70vh] py-20 px-4 mx-8  rounded-3xl flex items-center justify-center`} style={{ backgroundColor: `var(--${themeColor})` }}>

    <div>
      <h1 className="text-7xl font-semibold mb-4">{content.title}</h1>
      <h2 className="text-4xl font-normal mb-8">{content.subtitle}</h2>
